...
keyboard = [
    ...
    [InlineKeyboardButton("Andijon", callback_data="andijon"), InlineKeyboardButton("Jizzax", callback_data="jizzax")],
    [InlineKeyboardButton("Farg'ona", callback_data="farg'ona"),
     InlineKeyboardButton("Namangan", callback_data="namangan")],
    [InlineKeyboardButton("Qoraqalpog'iston Respublikasi", callback_data="qoraqalpoq")]
]
back = [
...
def callback_handler(update: Update, context: CallbackContext):
    ...
    if query.data != "back":
        try:
            ...
            data = res.json()
            city = translator.translate(data['name'], 'uz').text
